...
pip install -e ".[dev]"
pytest -q                     # 코어만 설치 시 위임/렌더 테스트는 skip · extras 설치 로컬 기준 236 passed / 1 skipped
# 편집·생성·리치 내보내기(위임) 사용:
...
├─ tests/                   # 237 collected + fixtures (PII 없는 빈 양식·정부 보고서 템플릿)
